...
Optional: small promo tile 440×280, marquee 1400×560 (not provided; the store accepts a listing without them).
...
4. Fill the listing, privacy tab and assets from this file; set visibility (public or unlisted), then submit. Review usually takes 1 to 3 days; a `world: MAIN` content script and a host permission may trigger a question from the reviewer, the justifications above answer it.
